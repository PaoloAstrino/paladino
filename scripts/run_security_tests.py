...
class SecurityTestRunner:
    ...
    def run_all(self, categories: Optional[List[str]] = None) -> bool:
        ...
        print(f"\n{'='*70}")
        print(f"🛡️  Paladino Security Test Suite")
        print(f"{'='*70}")
    ...
    def test_authentication(self):
        ...
        try:
            from paladino.app.security import verify_api_key, require_auth
            self._add_result(TestResult(
    ...
    def generate_report(self, output_file: str):
        ...
        for cat, results in sorted(categories.items()):
            ...
            report.append(f"| Test | Status | Message |")
            report.append(f"|------|--------|---------|")
...
def main():
    ...
    parser.add_argument(
        "--category", "-c",
        nargs="+",
        choices=["authentication", "rate_limiting", "cors", "injection",
                 "validation", "headers", "audit", "tracing", "errors",
                 "edge_cases", "all"],
        default=["all"],
