...
def test_opencup_pipeline_e2e(clean_neo4j, tmp_path):
    ...
    with clean_neo4j.session() as session:
        result = session.run("MATCH (t:Tender) WHERE t.source = 'TEST' RETURN t.cig as cig, t.importo as importo, t.oggetto as oggetto, t.data_aggiudicazione as data_aggiudicazione")
