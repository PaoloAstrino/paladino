...
class AnacOcdsTransformer:
    ...
    def extract_tenders(self, ocds_data: dict) -> pl.DataFrame:
        ...
        for release in items:
            ...
            tender = {
                ...
                "data_apertura": self._extract_date(tender_data.get("tenderPeriod", {}).get("startDate")),
                "data_aggiudicazione": self._extract_date(tender_data.get("awardPeriod", {}).get("endDate")),
                "source": self.source,
    ...
    def _extract_amount(self, value_obj: dict) -> Optional[float]:
    ...
    def _extract_piva(self, cf: str) -> Optional[str]:
