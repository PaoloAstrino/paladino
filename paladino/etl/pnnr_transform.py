...
class PnnrTransformer:
    ...
    def transform_soggetti(self, df: pl.DataFrame) -> Dict[str, pl.DataFrame]:
        ...
        companies = df.select([
            ...
            pl.col("cf").is_not_null() & (pl.col("cf").str.strip_chars() != "")
        ).unique(subset=["cf"])
    ...
    def transform_subappaltatori(self, df: pl.DataFrame) -> Dict[str, pl.DataFrame]:
        ...
        sub_companies = df.select([
            ...
            pl.col("Descrizione Forma Giuridica Sub-Appaltatore").cast(pl.String).alias("forma_giuridica"),
        ...
        sub_to_tender = df.select([
            ...
            pl.col("tender_cig").is_not_null() & (pl.col("tender_cig") != "") &
            pl.col("sub_cf").is_not_null() & (pl.col("sub_cf").str.strip_chars() != "")
        )
